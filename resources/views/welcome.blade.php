                ...
                <div class="row pr-lg-2">
                    ...
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="smooth-scroll">
                            ...
                            <p> الشركة الفلسطينية للعناية بالسيارات هي شركة فلسطينية تم انشائها عام 2020 بتمويل من السيد
                                محمد فايز .. وهنا باقي النص راح يكون بناء على الي تم تعبئته .. بلا بلا بلا.</p>
                ...
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center orange darken-3 text-white">
                        <div class="card-body">
                            ...
                            <h5 class="font-weight-normal my-4 py-2"><a class="text-white" href="#">غسيل السيارات</a>
                            </h5>
                            <p class="mb-4">He polite be object change. Consider no overcame yourself sociable
                                children.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <h5 class="font-weight-normal my-4 py-2"><a class="dark-grey-text" href="#">اصلاح
                                    البناشر</a></h5>
                            <p class="text-muted mb-4">He polite be object change. Consider no overcame yourself
                                sociable children.</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="cars-select">
                                        ...
                                        @foreach($bundle->prices()->get() as $p)
                                            <div class="custom-control custom-radio">
                                                <input data-bundle="bundle-price-text-{{$bundle->id}}"
                                                       data-price="{{$p->price}}" value="{{ $p->id }}" type="radio"
                                                       class="custom-control-input car-select" id="carSelect{{$p->id}}"
                                                       name="bundle_price">
                                                <label class="custom-control-label"
                                                       for="carSelect{{$p->id}}">{{$p->car()->first()->name}}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    <a href="{{ route('reserve') }}"
                                            class="btn darken-3 btn-orange btn-rounded d-flex justify-content-center mx-auto flex-row-reverse">
                                        <span>اطلب الان</span>
                                        <span style="direction: rtl" id="bundle-price-text-{{$bundle->id}}"
                                              class="ml-2"></span>
                                    </a>
                                </div>
                            </div>
